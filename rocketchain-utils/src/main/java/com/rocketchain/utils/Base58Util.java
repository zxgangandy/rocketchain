...
public class Base58Util {
    ...
    public static void main(String[] args) {
        Base58Util base = new Base58Util();
        System.out.println(base.encode("abc0001231231223123".getBytes()));
        System.out.println(new String(base.decode("Jq3DatBtCD1SCLduBmjmrcRCPU")));
    }
